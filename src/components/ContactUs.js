...
const ContactUs = () => {
  return (
    <div className="flex flex-col p-10 items-center justify-center space-y-3 mt-8">
      ...
      <div className="flex flex-row items-start space-x-10 border-[2px] rounded-lg justify-center bg-white shadow-md">
        <img
          src={nurse}
          alt="nurse"
          className="rounded-tl-lg rounded-bl-lg h-[28rem]"
        />
        <form className="flex flex-col space-y-10 p-3">
